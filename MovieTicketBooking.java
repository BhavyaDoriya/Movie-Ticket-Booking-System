...
class Customer {
    ...
    void bookYourMovie()
    {
        ...
        String nameofBooking=s.nextLine();
        for(;;)
        {
            nameofBooking=s.nextLine();
        ...
        String nameOfTheatre=s.nextLine();
        boolean check=false;
